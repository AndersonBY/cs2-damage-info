...
[HybridMind1337/CS2-Hybrid-DamageInfo](https://github.com/HybridMind1337/CS2-Hybrid-DamageInfo).

## Branches and upstream changes

- The default branch contains reviewed MBSifu maintenance patches.
- The `upstream` source is `HybridMind1337/CS2-Hybrid-DamageInfo:main`.
